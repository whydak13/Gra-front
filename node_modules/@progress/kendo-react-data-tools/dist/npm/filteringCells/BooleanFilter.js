...
var settings = {
    ...
    operatorComponent: function (props, cellProps) {
        ...
        return (React.createElement(kendo_react_dropdowns_1.DropDownList, __assign({}, props, { value: props.data.find(function (x) { return x.operator === (current ? current.value : ''); }), onChange: function (e) {
